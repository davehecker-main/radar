...
must(command, [
  ...
  /Omit untriaged `New` and frozen `HOLD` cards/,
  /Repository access is a hard prerequisite/, /failed, malformed, or incomplete/i,
  /stop the command immediately/i, /manufacture a recommendation/i,
  ...
  /Every invocation, before recommending/i, /agentbus state/,
  /agentbus who --repo --coverage/, /git ls-remote --heads origin/,
